                    ...
                    <div className="container">
                        <div className="content-footer py-[60px] flex justify-between flex-wrap gap-y-8">
                            <div className="company-infor basis-1/4 max-lg:basis-full pr-7">
                                 <Link href={'/homepages/fashion8'} className="logo">
                                    <Image
                                ...
                                <div className='flex gap-3 mt-3'>
                                    ...
                                    <div className="flex flex-col ">
                                        <span className=''>Info@futurexasolutions.com</span>
                                        <span className='mt-3'>+1 365-829-1344‬</span>
                                        <span className='mt-3 pt-px'>145 1/2 Church St, Toronto, CA</span>
                                    </div>
                                </div>
                            </div>
                            <div className="right-content flex flex-wrap gap-y-8 basis-3/4 max-lg:basis-full">
                                ...
                                <div className="newsletter basis-1/3 pl-7 max-md:basis-full max-md:pl-0">
                                    <div className="text-button-uppercase"></div>
                        ...
                        <div className="footer-bottom py-3 flex items-center justify-between gap-5 max-lg:justify-center max-lg:flex-col border-t border-line">
                            <div className="left flex items-center gap-8">
                                <div className="copyright caption1 text-secondary">©2025 FutuRexa Solutions Inc. All Rights Reserved.</div>
