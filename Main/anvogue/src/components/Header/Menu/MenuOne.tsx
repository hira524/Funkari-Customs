        ...
        <>
                    ...
                    <div className="container h-full">
                        <div className="menu-main h-full overflow-hidden">
                            <div className="heading py-2 relative flex items-center justify-center">
                                ...
                                <Link href={'/homepages/fashion8'} className='logo text-3xl font-semibold text-center'>Funkari Customs</Link>
                            </div>
            ...
            <div className="menu_bar fixed bg-white bottom-0 left-0 w-full h-[70px] sm:hidden z-[101]">
                <div className="menu_bar-inner grid grid-cols-4 items-center h-full">
                    <Link href={'/homepages/fashion8'} className='menu_bar-link flex flex-col items-center gap-1'>
