                        ...
                        <div className="left flex items-center h-full">
                            ...
                            <div className="menu-main style-eight h-full pl-12 max-lg:hidden">
                                <ul className='flex items-center gap-8 h-full'>
                                    <li className='h-full'>
                                       {/* <Link href="/homepages/fashion8" className='text-button-uppercase duration-300 h-full flex items-center justify-center'>
                                            Home
                                        </Link>*/}
                                    </li>
                                     <li className='h-full'>
                                            ...
                                            <div className="container">
                                                <div className="flex justify-between py-8">
                                                    ...
                                                    <div className="banner-ads-block pl-2.5 basis-1/3">
                                                        <div className="banner-ads-item bg-linear rounded-2xl relative overflow-hidden cursor-pointer" onClick={() => handleTypeClick('shoes')}>
                                                            <div className="text-content py-14 pl-8 relative z-[1]">
                                                                <div className="text-button-uppercase text-white bg-red px-2 py-0.5 inline-block rounded-sm">Save $50</div>
                                                                <div className="heading6 mt-2">Custom Sneakers <br />Collection</div>
                                                                <div className="body1 mt-3 text-secondary">
                                                                    Starting at <span className='text-red'>$180.00</span>
                                                                </div>
                                                            </div>
                                                            <Image
        ...
        {/* <div className="mega-menu absolute top-[44px] left-0 bg-white w-screen">
            <div className="container">
                        ...
                        <div className="list-product hide-product-sold  grid grid-cols-2 gap-5 mt-3">
                            {productData.filter(item => item.action === 'add to cart').slice(0, 2).map((prd, index) => (
                                <Product key={index} data={prd} type='grid' style='style-1' />
                                        ...
                                        <Link href="/blog/list" className='text-button-uppercase duration-300 h-full flex items-center justify-center'>
                                            Blog
                                        </Link>
                ...
                <ul>
                    ...
                    >
                        ...
                        <div className="sub-nav-mobile">
                            ...
                            <div className="list-nav-item w-full grid grid-cols-2 pt-2 pb-6">
                                <ul>
                                    <li>
                                        <Link href="/" className={`nav-item-mobile text-secondary duration-300 ${pathname === '/homepages/fashion8' ? 'active' : ''}`}>
                                            Home Fashion 1
                                        </Link>
                                    </li>
                                    <li>
                    ...
                    <li>
                        <Link href="#!" className='text-xl font-semibold flex items-center justify-between mt-5'>Features</Link>
                    </li>
                    <li>
                        <Link href="/shop/breadcrumb-img" className='text-xl font-semibold flex items-center justify-between mt-5'>Shop</Link>
                    </li>
                    <li>
                        <Link href="/product/default" className='text-xl font-semibold flex items-center justify-between mt-5'>Product</Link>
                    </li>
                    <li>
                    ...
                    <li>
                        <Link href="/pages/faqs" className='text-xl font-semibold flex items-center justify-between mt-5'>FAQs</Link>
                    </li>
