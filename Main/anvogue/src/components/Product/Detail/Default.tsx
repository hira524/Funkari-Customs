                            ...
                            <div className={`desc-item description ${activeTab === 'description' ? 'open' : ''}`}>
                                            ...
                                            <div className="item flex gap-1 text-secondary mt-1">
                                                <div>
                                                    {typeof productMain.careInstructions === 'string'
                                                        ? productMain.careInstructions.split('\n').map((line: string, idx: number) => (
                                ...
                                <div className="grid lg:grid-cols-4 grid-cols-2 gap-[30px] md:mt-10 mt-6">
                                    <div className="item">
                                        ...
                                        <div className="text-secondary mt-2">Get your custom sneakers delivered quickly and securely to your doorstep.</div>
                                    </div>
                                    <div className="item">
                                        <div className="icon-cotton text-4xl"></div>
                                        <div className="heading6 mt-4">Premium Materials</div>
                                        <div className="text-secondary mt-2">Crafted with high-quality leather and durable materials for lasting comfort.</div>
                                    </div>
                                    <div className="item">
                                        <div className="icon-guarantee text-4xl"></div>
                                        <div className="heading6 mt-4">Hand-Painted Art</div>
                                        <div className="text-secondary mt-2">Each pair features unique, hand-painted designs for a one-of-a-kind look.</div>
                                    </div>
                                    <div className="item">
                                        <div className="icon-leaves-compatible text-4xl"></div>
                                        <div className="heading6 mt-4">Care Instructions</div>
                                        <div className="text-secondary mt-2">Easy to maintain—see the care instructions above for best results.</div>
                                    </div>
                                </div>
                            </div>
                            <div className={`desc-item specifications flex items-center justify-center ${activeTab === 'specifications' ? 'open' : ''}`}>
                                <div className='lg:w-1/2 sm:w-3/4 w-full'>
                                    ...
                                    <div className="item bg-surface flex items-center gap-8 py-3 px-10">
                                        ...
                                        <p>
                                            {productMain.variation && productMain.variation.map(v => v.color).join(', ')}
                                        </p>
                                    </div>
                                    <div className="item flex items-center gap-8 py-3 px-10">
                                        <div className="text-title sm:w-1/4 w-1/3">Care</div>
                                        <div className="flex items-center gap-2">
                                            <span className="text-secondary">{productMain.careInstructions ? "See care instructions above" : "Wipe clean with a damp cloth"}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="top-overview flex justify-between py-6 max-md:flex-col gap-y-6">
                            <div className="rating lg:w-1/4 md:w-[30%] lg:pr-[75px] md:pr-[35px]">
                                <div className="heading flex items-center justify-center flex-wrap gap-3 gap-y-4">
                                    <div className="text-display">{productMain.rate ? productMain.rate.toFixed(1) : "5.0"}</div>
                                    <div className='flex flex-col items-center'>
                                        <Rate currentRate={productMain.rate || 5} size={18} />
                                        <div className='text-secondary text-center mt-1'>({productMain.sold ? productMain.sold * 200 : 1968} Ratings)</div>
                                    </div>
                                </div>
                            ...
                            <div className="list-img lg:w-3/4 md:w-[70%] lg:pl-[15px] md:pl-[15px]">
                                <div className="heading5">All Images ({productMain.images?.length || 0})</div>
                                <div className="list md:mt-6 mt-3">
                                    ...
                                    >
                                        {productMain.images && productMain.images.map((img, idx) => (
                                            <SwiperSlide key={idx}>
                                                <Image
                                                    src={img}
                                                    width={400}
                            ...
                            <div className="item flex max-lg:flex-col gap-y-4 w-full py-6 border-t border-line">
                                <div className="left lg:w-1/4 w-full lg:pr-[15px]">
                                    <div className="list-img-review flex gap-2">
                                        <Image
                                            src={'/images/products/product (18)/p18 (1).png'}
                                            width={200}
                                            height={200}
                                        ...
                                        />
                                        <Image
                                            src={'/images/products/product (19)/p19 (1).png'}
                                            width={200}
                                            height={200}
                                        ...
                                        />
                                        <Image
                                            src={'/images/products/product (20)/p20 (1).png'}
                                            width={200}
                                            height={200}
                                    ...
                                    <div className="user mt-3">
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            <div className="text-secondary2"><span>Grey</span> / <span>10</span></div>
                                        </div>
                                    </div>
                                </div>
                                <div className="right lg:w-3/4 w-full lg:pl-[15px]">
                                    ...
                                    <div className="body1 mt-3">
                                        The Nike Jordan HOWL is a masterpiece. The hand-painted details are stunning and the comfort is top-notch. Highly recommend for collectors!
                                    </div>
                                ...
                                <div className="left lg:w-1/4 w-full lg:pr-[15px]">
                                    ...
                                    <div className="user mt-3">
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            <div className="text-secondary2">-</div>
                                            <div className="text-secondary2"><span>Black</span> / <span>9</span></div>
                                        </div>
                                    </div>
                                </div>
                                <div className="right lg:w-3/4 w-full lg:pl-[15px]">
                                    ...
                                    <div className="body1 mt-3">
                                        The Devil Jin Customs are so cool! The artwork is exactly like the game and the shoes are super comfortable.
                                    </div>
                                    <div className="action mt-3">
                                        <div className="flex items-center gap-4">
                                            <div className="like-btn flex items-center gap-1 cursor-pointer">
                                ...
                                <div className="left lg:w-1/4 w-full lg:pr-[15px]">
                                    ...
                                    <div className="user mt-3">
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            <div className="text-secondary2">-</div>
                                            <div className="text-secondary2"><span>Red</span> / <span>11</span></div>
                                        </div>
                                    </div>
                                </div>
                                <div className="right lg:w-3/4 w-full lg:pl-[15px]">
                                    ...
                                    <div className="body1 mt-3">
                                        The Bloody Skull AF1s are a real head-turner. The red accents and skull art are amazing. Will buy again!
                                    </div>
                                    <div className="action mt-3">
                                        <div className="flex items-center gap-4">
                                            <div className="like-btn flex items-center gap-1 cursor-pointer">
